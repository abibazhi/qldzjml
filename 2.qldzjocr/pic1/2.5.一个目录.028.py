        ...
        if file.lower().endswith(('.png', '.jpg', '.jpeg')):
            ...
            try:
                ...
                for line in result[0]:
                    ...
                    if background_type == "Dark background with light text" and len(recognized_text) > 2:
                ...
                if text_block_count < 10 and file_size > 40 * 1024:
                    ...
                    for line in result[0]:
                        ...
                        if background_type == "Dark background with light text" and len(recognized_text) > 4:
                            dark_bg_texts_for_small_large.append(recognized_text)
                    if dark_bg_texts_for_small_large:
                        texts_str = '; '.join(dark_bg_texts_for_small_large)
