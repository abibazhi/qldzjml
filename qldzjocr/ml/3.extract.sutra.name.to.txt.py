...
# 将提取的内容写入文本文件
with open('3.sutra-name-list.txt', 'w', encoding='utf-8') as txt_file:
    for text in second_col_texts:
        txt_file.write(text + '\n')

print("第二列内容已提取并保存到 sutra-name-list.txt")
